...
export TMPDIR=/tmp/s2asag_ieee-fraud-detection
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 2 --runtime 14400 -m 180G -t ieee-fraud-detection -f AutoSklearnAutoGluonStrategy
cd $TMPDIR

...
export TMPDIR=/tmp/sasag_ieee-fraud-detection
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 4 --runtime 28800 -m 180G -t ieee-fraud-detection -f AutoSklearnAutoGluonStrategy
cd $TMPDIR

...
python run_kaggle.py  --iterative True -c 4 --runtime 3600 --half_for_test true -m 180G -t otto-group-product-classification-challenge -f AutoSklearnAutoGluonStrategy
cd $TMPDIR

...
export TMPDIR=/tmp/asei_ieee-fraud-detection
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 4 --runtime 14400 -m 180G -t ieee-fraud-detection -f AutoSklearnEnsembleIntensification
cd $TMPDIR

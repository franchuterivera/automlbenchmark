...
python run_kaggle.py --category_forced true --iterative true   -c 4 --runtime 3600 -m 180G -t santander-customer-transaction-prediction -f AutoSklearnEnsembleIntensification
cd $TMPDIR

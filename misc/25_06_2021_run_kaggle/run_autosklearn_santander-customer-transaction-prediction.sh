...
export TMPDIR=/tmp/askl_santander-customer-transaction-prediction
mkdir $TMPDIR
...
python run_kaggle.py  -c 4 --runtime 3600 -m 180G -t santander-customer-transaction-prediction -f AutoSklearn
cd $TMPDIR

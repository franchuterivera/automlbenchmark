...
export TMPDIR=/tmp/askl_agstrategy_porto-seguro-safe-driver-prediction
mkdir $TMPDIR
...
python run_kaggle.py  -c 4 --runtime 3600 -m 180G -t porto-seguro-safe-driver-prediction -f AutoSklearnAutoGluonStrategy
cd $TMPDIR
find . -name '*pkl' -ls -delete
find . -name '*model' -ls -delete
find . -name '*npy' -ls -delete
find . -name '*ensemble' -ls -delete
cp -r $TMPDIR /home/riverav/AUTOML_BENCHMARK/automlbenchmark_fork/debug_autosklearn_agstrategy_porto-seguro-safe-driver-prediction

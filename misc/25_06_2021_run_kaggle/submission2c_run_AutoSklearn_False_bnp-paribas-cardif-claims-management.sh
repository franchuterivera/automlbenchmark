...
export TMPDIR=/tmp/s2as_bnp-paribas-cardif-claims-management
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 2 --runtime 14400 -m 180G -t bnp-paribas-cardif-claims-management -f AutoSklearn
cd $TMPDIR

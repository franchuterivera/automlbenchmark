...
export TMPDIR=/tmp/asag_walmart-recruiting-trip-type-classification
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 4 --runtime 3600 --half_for_test true -m 180G -t walmart-recruiting-trip-type-classification -f AutoSklearnAutoGluonStrategy
cd $TMPDIR

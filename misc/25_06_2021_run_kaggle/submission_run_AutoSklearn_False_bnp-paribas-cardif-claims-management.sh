...
export TMPDIR=/tmp/sas_bnp-paribas-cardif-claims-management
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 4 --runtime 28800 -m 180G -t bnp-paribas-cardif-claims-management -f AutoSklearn
cd $TMPDIR

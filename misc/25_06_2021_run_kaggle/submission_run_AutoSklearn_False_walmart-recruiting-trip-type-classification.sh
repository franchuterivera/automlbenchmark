...
export TMPDIR=/tmp/sas_walmart-recruiting-trip-type-classification
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 4 --runtime 28800 -m 180G -t walmart-recruiting-trip-type-classification -f AutoSklearn
cd $TMPDIR

...
export TMPDIR=/tmp/s2asag_walmart-recruiting-trip-type-classification
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 2 --runtime 14400 -m 180G -t walmart-recruiting-trip-type-classification -f AutoSklearnAutoGluonStrategy
cd $TMPDIR

...
export TMPDIR=/tmp/asei_otto-group-product-classification-challenge
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 4 --runtime 3600 --half_for_test true -m 180G -t otto-group-product-classification-challenge -f AutoSklearnEnsembleIntensification
cd $TMPDIR

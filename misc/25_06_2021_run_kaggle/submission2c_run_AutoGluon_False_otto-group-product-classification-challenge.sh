#!/bin/bash
export TMPDIR=/tmp/s2ag_otto-group-product-classification-challenge
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 2 --runtime 14400 -m 180G -t otto-group-product-classification-challenge -f AutoGluon
cd $TMPDIR

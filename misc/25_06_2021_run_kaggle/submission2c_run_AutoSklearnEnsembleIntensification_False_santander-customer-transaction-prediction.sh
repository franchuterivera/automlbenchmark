...
export TMPDIR=/tmp/s2asei_santander-customer-transaction-prediction
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 2 --runtime 14400 -m 180G -t santander-customer-transaction-prediction -f AutoSklearnEnsembleIntensification
cd $TMPDIR

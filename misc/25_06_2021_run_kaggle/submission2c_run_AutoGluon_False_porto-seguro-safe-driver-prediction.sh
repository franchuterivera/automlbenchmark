#!/bin/bash
export TMPDIR=/tmp/s2ag_porto-seguro-safe-driver-prediction
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 2 --runtime 14400 -m 180G -t porto-seguro-safe-driver-prediction -f AutoGluon
cd $TMPDIR

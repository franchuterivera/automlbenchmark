...
export TMPDIR=/tmp/as_bnp-paribas-cardif-claims-management
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 4 --runtime 14400 -m 180G -t bnp-paribas-cardif-claims-management -f AutoSklearn
cd $TMPDIR

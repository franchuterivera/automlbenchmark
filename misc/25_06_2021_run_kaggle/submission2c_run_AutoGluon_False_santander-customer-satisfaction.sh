#!/bin/bash
export TMPDIR=/tmp/s2ag_santander-customer-satisfaction
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 2 --runtime 14400 -m 180G -t santander-customer-satisfaction -f AutoGluon
cd $TMPDIR

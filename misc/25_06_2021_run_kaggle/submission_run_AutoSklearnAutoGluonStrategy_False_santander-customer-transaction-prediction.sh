...
export TMPDIR=/tmp/sasag_santander-customer-transaction-prediction
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 4 --runtime 28800 -m 180G -t santander-customer-transaction-prediction -f AutoSklearnAutoGluonStrategy
cd $TMPDIR

#!/bin/bash
export TMPDIR=/tmp/s2ag_bnp-paribas-cardif-claims-management
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 2 --runtime 14400 -m 180G -t bnp-paribas-cardif-claims-management -f AutoGluon
cd $TMPDIR

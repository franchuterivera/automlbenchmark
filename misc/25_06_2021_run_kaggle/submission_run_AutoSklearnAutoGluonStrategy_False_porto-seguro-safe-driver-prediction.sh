...
export TMPDIR=/tmp/sasag_porto-seguro-safe-driver-prediction
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 4 --runtime 28800 -m 180G -t porto-seguro-safe-driver-prediction -f AutoSklearnAutoGluonStrategy
cd $TMPDIR

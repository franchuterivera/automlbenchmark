...
export TMPDIR=/tmp/s2asei_santander-customer-satisfaction
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 2 --runtime 14400 -m 180G -t santander-customer-satisfaction -f AutoSklearnEnsembleIntensification
cd $TMPDIR

#!/bin/bash
export TMPDIR=/tmp/ag_santander-customer-transaction-prediction
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 4 --runtime 3600 --half_for_test true -m 180G -t santander-customer-transaction-prediction -f AutoGluon
cd $TMPDIR

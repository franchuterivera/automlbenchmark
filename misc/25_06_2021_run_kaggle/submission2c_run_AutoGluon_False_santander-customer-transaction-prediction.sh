#!/bin/bash
export TMPDIR=/tmp/s2ag_santander-customer-transaction-prediction
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 2 --runtime 14400 -m 180G -t santander-customer-transaction-prediction -f AutoGluon
cd $TMPDIR

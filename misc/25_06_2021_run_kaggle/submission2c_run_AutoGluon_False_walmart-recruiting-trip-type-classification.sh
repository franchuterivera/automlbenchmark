#!/bin/bash
export TMPDIR=/tmp/s2ag_walmart-recruiting-trip-type-classification
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 2 --runtime 14400 -m 180G -t walmart-recruiting-trip-type-classification -f AutoGluon
cd $TMPDIR

...
export TMPDIR=/tmp/s2asag_otto-group-product-classification-challenge
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 2 --runtime 14400 -m 180G -t otto-group-product-classification-challenge -f AutoSklearnAutoGluonStrategy
cd $TMPDIR

...
export TMPDIR=$TMPDIR/debug_autogluon_porto-seguro-safe-driver-prediction
mkdir $TMPDIR
...
python run_kaggle.py  -c 8 --runtime 3600 -m 32G -t porto-seguro-safe-driver-prediction -f AutoGluon
cd $TMPDIR

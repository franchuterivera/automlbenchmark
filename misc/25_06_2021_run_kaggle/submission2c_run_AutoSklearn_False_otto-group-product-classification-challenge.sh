...
export TMPDIR=/tmp/s2as_otto-group-product-classification-challenge
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 2 --runtime 14400 -m 180G -t otto-group-product-classification-challenge -f AutoSklearn
cd $TMPDIR

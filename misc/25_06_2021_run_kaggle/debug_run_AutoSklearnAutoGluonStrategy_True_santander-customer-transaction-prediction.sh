...
python run_kaggle.py  --iterative True -c 4 --runtime 3600 --half_for_test true -m 180G -t santander-customer-transaction-prediction -f AutoSklearnAutoGluonStrategy
cd $TMPDIR

...
export TMPDIR=/tmp/agl_otto-group-product-classification-challenge
mkdir $TMPDIR
...
python run_kaggle.py  -c 4 --runtime 3600 -m 180G -t otto-group-product-classification-challenge -f AutoGluon
cd $TMPDIR

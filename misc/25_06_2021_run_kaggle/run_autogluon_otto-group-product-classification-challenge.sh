...
export TMPDIR=$TMPDIR/debug_autogluon_otto-group-product-classification-challenge
mkdir $TMPDIR
...
python run_kaggle.py  -c 8 --runtime 3600 -m 32G -t otto-group-product-classification-challenge -f AutoGluon
cd $TMPDIR
find . -name '*pkl' -ls -delete
find . -name '*model' -ls -delete
find . -name '*npy' -ls -delete
find . -name '*ensemble' -ls -delete
cp -r $TMPDIR /home/riverav/AUTOML_BENCHMARK/automlbenchmark_fork/debug_autogluon_otto-group-product-classification-challenge

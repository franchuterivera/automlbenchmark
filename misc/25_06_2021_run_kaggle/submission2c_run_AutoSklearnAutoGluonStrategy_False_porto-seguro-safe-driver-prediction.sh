...
export TMPDIR=/tmp/s2asag_porto-seguro-safe-driver-prediction
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 2 --runtime 14400 -m 180G -t porto-seguro-safe-driver-prediction -f AutoSklearnAutoGluonStrategy
cd $TMPDIR

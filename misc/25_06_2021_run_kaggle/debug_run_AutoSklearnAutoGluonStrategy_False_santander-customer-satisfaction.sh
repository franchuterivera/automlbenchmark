...
export TMPDIR=/tmp/asag_santander-customer-satisfaction
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 4 --runtime 3600 --half_for_test true -m 180G -t santander-customer-satisfaction -f AutoSklearnAutoGluonStrategy
cd $TMPDIR

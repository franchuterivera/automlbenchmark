...
export TMPDIR=/tmp/agl_santander-customer-transaction-prediction
mkdir $TMPDIR
...
python run_kaggle.py  -c 4 --runtime 14400 -m 180G -t santander-customer-transaction-prediction -f AutoGluon
cd $TMPDIR

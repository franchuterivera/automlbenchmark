...
export TMPDIR=/tmp/s2asei_bnp-paribas-cardif-claims-management
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 2 --runtime 14400 -m 180G -t bnp-paribas-cardif-claims-management -f AutoSklearnEnsembleIntensification
cd $TMPDIR

...
export TMPDIR=$TMPDIR/debug_autogluon_santander-customer-satisfaction
...
python run_kaggle.py --subsample true -c 8 --runtime 3600 -m 32G -t santander-customer-satisfaction -f AutoGluon
cd $TMPDIR

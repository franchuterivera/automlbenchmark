...
export TMPDIR=/tmp/s2as_walmart-recruiting-trip-type-classification
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 2 --runtime 14400 -m 180G -t walmart-recruiting-trip-type-classification -f AutoSklearn
cd $TMPDIR

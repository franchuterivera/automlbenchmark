...
export TMPDIR=/tmp/agl_bnp-paribas-cardif-claims-management
mkdir $TMPDIR
...
python run_kaggle.py  -c 4 --runtime 3600 -m 180G -t bnp-paribas-cardif-claims-management -f AutoGluon
cd $TMPDIR

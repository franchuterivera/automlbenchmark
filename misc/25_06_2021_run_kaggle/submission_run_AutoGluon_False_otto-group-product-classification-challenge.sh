#!/bin/bash
export TMPDIR=/tmp/sag_otto-group-product-classification-challenge
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 4 --runtime 28800 -m 180G -t otto-group-product-classification-challenge -f AutoGluon
cd $TMPDIR

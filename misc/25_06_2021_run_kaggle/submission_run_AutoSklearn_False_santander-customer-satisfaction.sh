...
export TMPDIR=/tmp/sas_santander-customer-satisfaction
mkdir $TMPDIR
...
python run_kaggle.py  --iterative False -c 4 --runtime 28800 -m 180G -t santander-customer-satisfaction -f AutoSklearn
cd $TMPDIR

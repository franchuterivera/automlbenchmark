...
def save_frame(args, repeated_frame, history_frame):
    ...
    path = os.path.join(os.getenv('HOME'), f"df_repeated_stacking_hpo_{args.openml_id}.csv")
    pd.DataFrame(repeated_frame).to_csv(path)
    print(f"{time.ctime()}: saved {path}")
    path = os.path.join(os.getenv('HOME'), f"df_repeated_stacking_hpo_history_{args.openml_id}.csv")
...
HPO = {
    'HistGradientBoostingClassifier1': {
        'loss': 'auto',
        'learning_rate': 0.1,
        'max_iter': 100,
        'min_samples_leaf': 20,
    ...
    'HistGradientBoostingClassifier3': {
        'loss': 'auto',
        'learning_rate': 0.2,
        'max_iter': 100,
        'min_samples_leaf': 28,
    ...
    'XGBClassifier1': {'learning_rate': 0.1, 'booster': 'gbtree'},
    'XGBClassifier2': {'learning_rate': 0.01, 'booster': 'gbtree', 'max_depth': 19},
    'XGBClassifier3': {'learning_rate': 0.005, 'booster': 'gbtree', 'reg_lambda': 1},
    'LGBMClassifier1': {
        'boosting_type': 'gbdt',
        'learning_rate': 0.03,
        'two_round': True,
...
model_func = {
    'HistGradientBoostingClassifier1': HistGradientBoostingClassifier,
    'HistGradientBoostingClassifier2': HistGradientBoostingClassifier,
    'HistGradientBoostingClassifier3': HistGradientBoostingClassifier,
    'XGBClassifier1': XGBClassifier,
    'XGBClassifier2': XGBClassifier,
    'XGBClassifier3': XGBClassifier,
    'LGBMClassifier1': LGBMClassifier,
    'LGBMClassifier2': LGBMClassifier,
    'LGBMClassifier3': LGBMClassifier,
    'MLPClassifier1': MLPClassifier,
    'MLPClassifier2': MLPClassifier,
    'MLPClassifier3': MLPClassifier,
    'MLPClassifier4': MLPClassifier,
    'MLPClassifier5': MLPClassifier,
}

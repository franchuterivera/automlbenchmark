...
df = pd.read_csv('/home/chico/master_thesis/automlbenchmark/misc/13_02_2021_isolatedrepetitions/sklearn/lgbmhpo/ONLY_hpo/history/all_data.csv')
...
for dataset_name in data['dataset_name'].unique():
    ...
    for i, model in enumerate(data['model'].unique()):
        ...
        data[
            (data['model']==model) & (data['repeat']==5) & (data['dataset_name']==dataset_name)

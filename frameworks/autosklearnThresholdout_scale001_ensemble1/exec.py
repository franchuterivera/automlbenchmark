...
def run(dataset, config):
    ...
    thresholdout_scale = 0.01
    if 'thresholdout_scale' in training_params:
        thresholdout_scale = training_params.pop('thresholdout_scale')

    ensemble_builder_thresholdout = 1
    if 'ensemble_builder_thresholdout' in training_params:
        ensemble_builder_thresholdout = training_params.pop('ensemble_builder_thresholdout')
    ...
    auto_sklearn = estimator(time_left_for_this_task=config.max_runtime_seconds,
                             ...
                             resampling_strategy_arguments={'thresholdout_scale': thresholdout_scale},

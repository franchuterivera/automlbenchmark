...
def get_smac_object_callback(repeats, level):
    def get_smac_object(
        ...
        return BOHB4HPO(
            ...
            #initial_design=None if initial_configurations is not None else RandomConfigurations,
            run_id=run_id,
            intensifier_kwargs={
                'initial_budget': 1,
...
def run(dataset, config):
    ...
    auto_sklearn = estimator(time_left_for_this_task=config.max_runtime_seconds,
                             ...
                             resampling_strategy_arguments={'folds': k_folds,
                                                            ...
                                                            'repeats': repeats},
                             get_smac_object_callback=get_smac_object_callback(repeats, max_stacking_level),
                             seed=config.seed,
                             **constr_extra_params,
                             **training_params)

...
def get_smac_object_callback(max_ensemble_members, min_challengers, repeats_as_individual_models, only_intensify_members_repetitions):
    def get_smac_object(
        scenario_dict,
        run_id,
        seed,
...
def run(dataset, config):
    ...
    auto_sklearn = estimator(time_left_for_this_task=config.max_runtime_seconds,
                             ...
                             resampling_strategy_arguments={'folds': k_folds,
                                                            ...
                                                            'only_intensify_members_repetitions': only_intensify_members_repetitions,
                                                            'repeats': repeats},
                             get_smac_object_callback=get_smac_object_callback(max_ensemble_members, min_challengers, repeats_as_individual_models, only_intensify_members_repetitions=only_intensify_members_repetitions),
                             seed=config.seed,
                             **constr_extra_params,
                             **training_params)

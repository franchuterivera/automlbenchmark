...
def get_smac_object_callback(max_ensemble_members, min_challengers, repeats_as_individual_models, fast_track_performance_criteria):
    def get_smac_object(
        scenario_dict,
        run_id,
        seed,
...
def run(dataset, config):
    ...
    fast_track_performance_criteria = 'lower_bound'
    ...
    auto_sklearn = estimator(time_left_for_this_task=config.max_runtime_seconds,
                             ...
                             resampling_strategy_arguments={'folds': k_folds,
                                                            ...
                                                            'repeats': repeats},
                             get_smac_object_callback=get_smac_object_callback(max_ensemble_members, min_challengers, repeats_as_individual_models, fast_track_performance_criteria),
                             seed=config.seed,
                             **constr_extra_params,
                             **training_params)

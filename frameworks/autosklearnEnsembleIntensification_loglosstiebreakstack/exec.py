...
def get_smac_object_callback(max_ensemble_members, min_challengers, repeats_as_individual_models):
    def get_smac_object(
        scenario_dict,
        run_id,
        seed,
...
def run(dataset, config):
    ...
    repeats_as_individual_models = False
    if 'repeats_as_individual_models' in training_params:
        repeats_as_individual_models = training_params.pop('repeats_as_individual_models')
    ...
    auto_sklearn = estimator(time_left_for_this_task=config.max_runtime_seconds,
                             ...
                             resampling_strategy_arguments={'folds': k_folds,
                                                            ...
                                                            'repeats': repeats},
                             get_smac_object_callback=get_smac_object_callback(max_ensemble_members, min_challengers, repeats_as_individual_models),
                             seed=config.seed,
                             **constr_extra_params,
                             **training_params)

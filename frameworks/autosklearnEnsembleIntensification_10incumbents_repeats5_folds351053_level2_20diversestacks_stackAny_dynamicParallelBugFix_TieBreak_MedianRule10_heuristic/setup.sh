...
cd ${TARGET_DIR}
git checkout cvavgintensifier_levels_meta_ES_rebase3_medianrule_heuristic
cd ${HERE}
...
cd SMAC3
git checkout use_max_budget_seen_ensembleintensifier_ES_dynamic_medianfix_l2fast
cd ${HERE}
PIP install -e SMAC3

...
def get_smac_object_callback(max_ensemble_members, min_challengers, fidelities_as_individual_models, fast_track_performance_criteria, only_intensify_members_repetitions):
    def get_smac_object(
        scenario_dict,
        run_id,
        seed,

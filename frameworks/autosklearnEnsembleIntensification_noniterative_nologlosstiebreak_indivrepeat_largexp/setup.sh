...
cd ${TARGET_DIR}
git checkout cvavgintensifier_rebase3_towering_largedatasets_3fold
cd ${HERE}
...
cd SMAC3
git checkout ensembleintensifier_ES_dynamic_medianl2fastfix_towering_sameasintensify_large
cd ${HERE}
PIP install -e SMAC3

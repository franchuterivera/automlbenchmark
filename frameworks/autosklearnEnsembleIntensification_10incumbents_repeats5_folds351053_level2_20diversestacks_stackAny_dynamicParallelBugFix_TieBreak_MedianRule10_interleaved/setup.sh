...
cd ${TARGET_DIR}
git checkout cvavgintensifier_levels_meta_ES_rebase3_medianrule_heuristic_interleaved
cd ${HERE}
...
cd SMAC3
git checkout use_max_budget_seen_ensembleintensifier_ES_dynamic_medianfix_interleaved
cd ${HERE}
PIP install -e SMAC3

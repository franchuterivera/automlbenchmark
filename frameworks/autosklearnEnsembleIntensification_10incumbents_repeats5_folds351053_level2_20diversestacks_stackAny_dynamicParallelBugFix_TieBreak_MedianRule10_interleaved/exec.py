...
def get_smac_object_callback(max_ensemble_members, min_challengers):
    def get_smac_object(
        scenario_dict,
        run_id,
        seed,
        ...
        from smac.intensification.parallel_ensemble_intensification import EnsembleIntensification
...
def run(dataset, config):
    ...
    auto_sklearn = estimator(time_left_for_this_task=config.max_runtime_seconds,
                             ...
                             resampling_strategy_arguments={'folds': k_folds,
                                                            ...
                                                            'repeats': repeats},
                             get_smac_object_callback=get_smac_object_callback(max_ensemble_members, min_challengers),
                             seed=config.seed,
                             **constr_extra_params,
                             **training_params)

...
def run(dataset, config):
    ...
    fraction_time_for_this_smbo = 0.25
    if 'fraction_time_for_this_smbo' in training_params:
        fraction_time_for_this_smbo = training_params.pop('fraction_time_for_this_smbo')
    ...
    auto_sklearn = estimator(time_left_for_this_task=config.max_runtime_seconds,
                             ...
                             fraction_time_for_this_smbo=fraction_time_for_this_smbo,
                             seed=config.seed,
                             **constr_extra_params,
                             **training_params)
